-- ====================================================================
-- MIGRACIÓN SIMPLE PARA LABORATORIO LÓPEZ - SISTEMA DE TARIFAS
-- ====================================================================

-- 1. VERIFICAR SI YA EXISTEN PRECIOS EN TARIFF_PRICES
SELECT 
  COUNT(*) as total_precios_existentes,
  'Si es > 0, la migración ya se ejecutó' as nota
FROM tariff_prices;
...
-- Mostrar primeros precios migrados
SELECT 
  a.name as analisis,
  t.name as tarifa,
  tp.price as precio
