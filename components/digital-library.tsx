  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Biblioteca Digital</h2>

        <div className="relative">
          <div className="flex gap-8 overflow-hidden px-12">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 bg-[#1E5FAD] hover:bg-[#1E5FAD]/90 text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 bg-[#1E5FAD] hover:bg-[#1E5FAD]/90 text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10"
          >
