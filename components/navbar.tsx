  ...
  if (hasDropdown) {
    return (
      <button
        ...
        } hover:text-[#2EB9A5] transition-colors flex items-center gap-1`}
      >
        {etiqueta}
                        ...
                        {showResultadosDropdown && (
                          <div className="ml-7 mt-2 flex flex-col gap-3 bg-gray-50 p-4 rounded-lg">
                            <p className="text-sm mb-2">
                              Consulta el <span className="text-[#0066FF] font-medium">estado</span> y detalle de tus{" "}
                              <span className="text-[#0066FF] font-medium">análisis</span>.
                            </p>
                            <SheetClose asChild>
                              <Link
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <div className="md:col-span-4 mb-4 text-center">
                        <p className="text-lg text-gray-700">
                          Consulta el <span className="text-[#0066FF] font-semibold">estado</span> y detalle de tus{" "}
                          <span className="text-[#0066FF] font-semibold">análisis</span>.
                        </p>
                      </div>
